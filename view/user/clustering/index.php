              ...
              <div id="page-content">
                             ...
                             <label class="col-sm-3 control-label">Description Job*</label>
                              <div class="col-sm-5">
                                  <input type="text" class="form-control" id="descJob" name="descJob" />
													...
													<div class="form-group">
              							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="encodingOption">Encoding Option <span class="required">*</span>
              							</label>

                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="encodingOption" class="form-control">
																<option value="1">Ordinal Encoder</option>
                                <option value="0">One hot encoder</option>
                              </select>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Clustering Module</h3>
                        </div>
                        <div class="panel-body">
                          The clustering module allows, from a set of data, to generate groups of elements with respect to the examples and the characteristics they possess. The general objective is to generate divisions that have similar behaviors among themselves and that, in turn, are different from other groups. This type of analysis is the first instance that is carried out when you want to look for patterns based on data behaviors. Different algorithms are implemented in this module: K-Means, DBScan, Mean Shift, Affinity Propagation, Birch, Agglomerates and Hierarchical. All generated models are evaluated by criteria of similarities and disaggregation. This module allows to generate clustering from the selection of a particular algorithm or to make a sweep of the different algorithms that have been implemented. It requires a preprocessing to the information, which is based on the manipulation of the information with respect to scales and numerical transformations of the data.
                        </div>
                    </div>
                  </div>
                </div>
