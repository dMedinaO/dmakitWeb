              ...
              <div id="page-content">
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Supervised Learning for classifiers module</h3>
                        </div>
                        <div class="panel-body">
                          The supervised learning module for the training of classification models is a tool that facilitates the exploration of different algorithms based on different instances: classification based on distances, application of neural networks, development of decision trees, manipulation of kernel functions for space transformations, etc. Each set of data uploaded to the platform is treated with respect to the options selected in the scale application to generate the normalization, those attributes that are of the discrete type, are transformed to numerical frequency values, the classes are encoded to numerical values in indexes starting in 1. The evaluation of the overfit is done through cross validation or Leave one Out. Cross validation is recommended for those cases where the number of examples is high and Leave one out when the examples are scarce.
                        </div>
                    </div>
                  </div>
                </div>
