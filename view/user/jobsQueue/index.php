              ...
              <div id="page-content">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12" id="init" style="display:none;">
                    <div class="alert alert-success" role="alert">
                      This job is in START status, It will notify by email when change status of job
                    </div>
                  </div>

                  <div class="col-sm-12 col-md-12 col-lg-12" id="canceled" style="display:none;">
                    <div class="alert alert-danger" role="alert">
                      This job is in CANCELED status.
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Jobs in Queue System</h3>
                        </div>
                        <div class="panel-body">
                          The works in the system of queues, are processes that its execution presents a considerable time of computational cost, reason why they are left running in background and the term of the process is notified. Works that exceed 3 days of execution will be CANCELED and the reason will be notified by mail. The exploration of classification and prediction models allows the user to evaluate various combinations of parameters, which are associated with the algorithms. As a result, histograms of each performance measure are generated and a ranking of the best results obtained by performance. The data set must provide the answer or classification in the final column. Data transformation will be applied to frequencies for the case that they are discrete attributes. Standardization is applied to the elements using the normality scale.
                        </div>
                    </div>
                  </div>
                </div>
