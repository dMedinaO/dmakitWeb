...
<head>
    ...
    <script src="../js/linearModels/execAlgorithm.js"></script>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="algorithm" class="form-control">
                                ...
                                <option value="1">Bayesian Regression</option>
                                <option value="2">Elastic-Net</option>
                                <option value="3">Lars Lasso</option>
                                <option value="4">Lasso</option>
                                <option value="5">Ordinal Least Square</option>
                                <option value="6">Ridge Regression</option>
                              </select>
                            </div>
                          </div>
