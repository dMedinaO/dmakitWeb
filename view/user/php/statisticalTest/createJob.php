<?php
  ...
  if ($requestData == "BIEN"){#movemos el archivo de tmp al path del usuario y ejecutamos el proceso solo si la opcion de algorithm es todos...
    ...
    $pathActual = "/var/www/html/smartTraining/dataStorage/tmp/statisticalTest/$nameDocument";
    ...
    $command = "python /var/www/html/smartTraining/model/LauncherStatisticalTest.py $pathMove$nameDocument $option";
    $output = [];
    exec($command, $output);
