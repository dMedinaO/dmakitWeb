...
<head>
    ...
    <script src="../js/statistical/createJob.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Statistical Analysis Process</h1>
              ...
              <div id="page-content">
                  ...
                  <div class="col-sm-12 col-md-12">
                    ...
                    <div class="panel panel-bordered panel-primary">
                      ...
                      <div class="panel-body">
                        <form id="frmAgregarFile" action="../php/uploadFileStatistical.php" class="dropzone" >
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="processJob" class="form-control">
                                <option value="0">View Data continue</option>
                                <option value="1">Distribution Analysis</option>
                                <option value="2">Dispersion Analysis Data</option>
                                <option value="3">Frequence of discrete attribute</option>
                                <option value="4">Parallel Coordinates</option>
                                <option value="5">Sploms Visualization</option>
                                <option value="6">Statistical Summary</option>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Statistics Module</h3>
                        </div>
                        <div class="panel-body">
                          Different statistical analyzes and visualizations of the data can be applied in the statistics module. The visualization of discrete and continuous data is possible, the dispersion evaluation, possible distributions, parallel coordinate graphs, scatter plots matrices and summary of simple statistics, are possible to calculate using this module.
                        </div>
                    </div>
                  </div>
                </div>
