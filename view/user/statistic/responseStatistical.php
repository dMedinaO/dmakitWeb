...
<head>
    ...
    <script src="../js/statistical/processViewStatistics.js"></script>
              ...
              <div id="page-content">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Summary Statistics data</h3>
                        </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Some definitions</h3>
                        </div>
                        <div class="panel-body">
                          The statistics that are calculated are: average, standard deviation, variance and maximum and minimum values. Average or mean is a single number taken as representative of a list of numbers. Standar Deviation is a measure that is used to quantify the amount of variation or dispersion of a set of data values.
