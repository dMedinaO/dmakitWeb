...
<head>
    ...
    <script src="../js/statistical/processViewSplom.js"></script>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Sploms for feature
                              <?php
                                echo $_GET['feature'];
                              ?>
                            </h3>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                          The scatterplot matrix, known acronymically as SPLOM, is a relatively uncommon graphical tool that uses multiple scatterplots to determine the correlation (if any) between a series of variables. These scatterplots are then organized into a matrix, making it easy to look at all the potential correlations in one place.
                        </div>
                    </div>
                  </div>
