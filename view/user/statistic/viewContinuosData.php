...
<head>
    ...
    <script src="../js/statistical/processViewContinuosData.js"></script>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">View Feature
                              <?php
                                echo $_GET['feature'];
                              ?>
                            </h3>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                          The characteristic of the continuous type in the form of a scatter plot with line combination is shown. The shape used is of the spline type, which allows to soften the points. In the y-axis, the values of the characteristic are represented, while in the x-axis, the position of each example, so that this axis has values between 0 and the number of existing examples in the data set.
                        </div>
                    </div>
                  </div>
                </div>
