...
<head>
    ...
    <script src="../js/statistical/processViewFrequence.js"></script>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Frequence value for feature
                              <?php
                                echo $_GET['feature'];
                              ?>
                            </h3>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                          The frequency of appearance of attributes of the discrete type is observed through a pie chart. Each type of possible value in the domain of the selected characteristic becomes visible together with its percentage of appearance. Said percentage is calculated based on the number of incidences of said value with respect to the total of existing examples in the data set.
                        </div>
                    </div>
                  </div>
