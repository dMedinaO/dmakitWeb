...
<head>
    ...
    <script src="../js/statistical/processViewDistribution.js"></script>
              ...
              <div id="page-content">
                  ...
                  <div class="col-lg-8 col-md-8 col-sm-8">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Histogram for feature:
                              <?php
                                echo $_GET['feature'];
                              ?>
                            </h3>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"> Aproximation of CDF for feature:
                              <?php
                                echo $_GET['feature'];
                              ?>
                            </h3>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                          The Shapiro–Wilk test is a test of normality in frequentist statistics. The Shapiro–Wilk test tests the null hypothesis that a sample x1, ..., xn came from a normally distributed population.
