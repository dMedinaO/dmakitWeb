              ...
              <div id="page-content">
                    ...
                    <div class="panel panel-bordered panel-primary">
                      ...
                      <div class="panel-body">
                        ...
                        <form id="initNewJob" method="post" class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="processJob" class="form-control">
                                ...
                                <option value="6">Incremental PCA</option>
													...
													<div class="form-group">
              							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="optionEncode">Option Encode<span class="required">*</span>
              							</label>

                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="optionEncode" class="form-control">
                          ...
                          <div class="form-group">
              							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="optionScale">Preprocessing Option <span class="required">*</span>
              							</label>

                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="optionScale" class="form-control">
																<option value="0">No Apply scale option</option>
                          ...
                          <div class="form-group" id="selectType" style="display:none;">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                              <select id="kindDataSet" class="form-control">
                                <option value="CLASS">With discrete Labels</option>
                                <option value="PREDICTION">With continuous response</option>
                              </select>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Characteristics Analysis Module</h3>
                        </div>
                        <div class="panel-body">
                          The feature analysis module allows different algorithms to be applied to the data set in order to evaluate their relevance in the data set or how the relationship between them is.
                          The algorithms implemented are: Mutual information, Principal Component Analysis and its variations, Matrices of correlation and spatial deformation through training with Random Forest evaluating trees and the most representative characteristics.
                          For all these analyzes, the type of pre-processing to be performed on the data sets must be selected. Initially, characteristics of the discrete type will be transformed by applying the frequency of appearance in the examples.
                          If you select analysis by spatial deformation, you will be asked to select the type of data set: CLASS or PREDICTION. The first one indicates that the answer is discrete, therefore it is a set of classification data. The second indicates that the answer is continuous, therefore, we work with regression algorithms. In addition to the type of data set, you will be asked to select the feature associated with the response.
                        </div>
                    </div>
                  </div>
                </div>
