                          ...
                          <tbody>
                            <tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  The analysis by deformation of space, is an algorithm that implements Random Forest as a method of classification / prediction (depending on the type of data set to be used and the response generated by the examples) and is based mainly on collecting information about the persistence of the attributes that generate a greater impact on the decisions of the random trees that are created and which generate a greater gain of information. A ranking is given with the most relevant attributes in percentage values, the sum of all of these contemplates 100% of the information.
                                </td>
                              </tr>
                          </tbody>
                        </table>
