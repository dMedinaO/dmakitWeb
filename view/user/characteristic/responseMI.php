...
<head>
    ...
    <script src="../js/characteristic/processViewMI.js"></script>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="panel panel-bordered panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Mutual Information</h3>
                        </div>
                        <div class="panel-body">
                          <div id="mutualInformationResponse"></div>
                        </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="panel-body">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <span class="text-main text-semibold">Mutual Information</span>
                                <br>
                              </td>
                             </tr>
                                  ...
                                  <td>
                                      <span class="text-main text-semibold">
                                        <?php
                                          ...
                                          echo "<a href=\"../../../dataStorage/$idUser/$job/MatrixMI_$job.csv\">";
                                          echo "dataResponse</a>";
