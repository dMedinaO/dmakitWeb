...
$query = "select count(CAST(job.createdJob  as DATE)) as cantidad, CAST(job.createdJob  as DATE) as fecha from job where job.tipo_job = 'PREDICTION' group by CAST(job.createdJob   as DATE)";
